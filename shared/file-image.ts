import { FILE_LIMITS, type FileMime, type FileRole } from "./files";
...
export function validateObjectInfo(
  ...
  if (
    ...
    throw new FileImageError(413, "The image exceeds the size or pixel limit.");
  if (
    role === "thumbnail" &&
